          ...
          <div className="col-12 col-lg-8 text-center">
            <div className="heading heading-12 heading-13" style={{ marginBottom: "10px" }}>
              <p className="heading-subtitle" style={{ color: "#7ecbe6" }}>
                Presente en las siguientes ciudades:
              </p>
              <h2
        ...
        <div className="row justify-content-center" style={{ marginTop: "40px" }}>
          <div className="col-12 col-lg-8 text-center">
            <p style={{ color: "#e0e0e0", fontSize: "15px" }}>
              + de <strong style={{ color: "var(--global--color-primary)", fontSize: "18px" }}>46 proyectos</strong> en{" "}
              <strong style={{ color: "var(--global--color-primary)", fontSize: "18px" }}>12 estados</strong> brasileños
            </p>
          </div>
        </div>
      </div>
